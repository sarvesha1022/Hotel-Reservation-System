<?php
    ...
    if(isset($_POST['get_all_rooms']))
    {
        ...
        {
            if($row['status']==1){
                $status = "<button onclick='toogle_status($row[id],0)' class='btn btn-dark btn-sm shadow-none'>active</button>";
            }
            else{
                $status = "<button onclick='toogle_status($row[id],1)' class='btn btn-warning btn-sm shadow-none'>inactive</button>";
            }
